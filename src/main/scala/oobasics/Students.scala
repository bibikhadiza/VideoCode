...
class Students(val firstName: String,
  ...
  def average: Double = quizAverage * 0.1 + assignmentAverage * 0.5 + testAverage*.4

  //if mutating data use parentheses otherwise it can be left off
