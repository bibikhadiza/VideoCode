...
object HelloWorld {
  ...
  * */
    ...
    /*Scopes in scala are encapsulated within blocks
  * declaration in scala: val, var, object, def
  * key work of the declaration followed by the name
  * After you declare something it can only live in a certain section in your program
  * it lives from point of declaration until the end of the curly braces that it lives inside of
  * arguments can only be used within the given method
  * */
